  ...
  return (
    <div className="p-8 mt-20 flex flex-col items-center gap-6 ">
      <div className="w-3/4 flex justify-around items-center bg-orange-300 py-4 rounded-lg drop-shadow-lg">
        <input
          className="w-3/5 py-2 rounded-lg border-2 border-orange-500 pl-2"
          type="text"
          placeholder="Search BootCamp ..."
          value={searchParams?.get("name_like")}
          onChange={(e) =>
        ...
        <label
          htmlFor="reg"
          className="bg-orange-500 py-1 px-2 rounded-lg text-white font-bold text-lg flex items-center gap-2"
        >
          <input
            type="checkbox"
            id="reg"
